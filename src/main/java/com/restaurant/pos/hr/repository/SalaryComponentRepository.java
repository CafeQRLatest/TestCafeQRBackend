...
public interface SalaryComponentRepository extends JpaRepository<SalaryComponent, UUID> {
    ...
    List<SalaryComponent> findByClientIdAndOrgIdOrGlobal(UUID clientId, UUID orgId);
    ...
    Optional<SalaryComponent> findByIdAndClientIdAndOrgIdOrGlobal(UUID id, UUID clientId, UUID orgId);
    ...
    List<SalaryComponent> findActiveComponents(UUID clientId, UUID orgId);
}
